...
const Gallery6 = () => {
    return (
            ...
            <div className="gallery gallery--stack gallery--stack-inverse gallery--stack-scale gallery--stack-dark" id="gallery-6">
                ...
                <div className="gallery__item" style={{ backgroundImage: 'url(/look01/08.jpg)' }}></div>
                <div className="gallery__item" style={{ backgroundImage: 'url(/look01/09.jpg)' }}></div>
                <div className="gallery__item" style={{ backgroundImage: 'url(/look01/10.jpg)' }}></div>
